...
EngineA = sqlalchemy.create_engine("mssql+pyodbc://" + "BI_Primary:" + "@234_MgaKaKa!"+"@InfoTrax_Prod") #Working
EngineB = sqlalchemy.create_engine("mssql+pyodbc://" + "aseauser:" + "@S34Pr0d"+"@ASEA_PROD") #working
EngineC = sqlalchemy.create_engine("mssql+pyodbc://" + "BI_Primary:" + "@234_MgaKaKa!"+"@ASEA_REPORTS") #working
...
# job =  Mainfunction("","""ACCOUNTYPE
# ,LEGACYNUMBER""", 'InfoTrax_Prod','dbo','Tbl_DISTRIBUTOR', """WHERE CreatedDate BETWEEN '2015-01-10' AND DATEADD(month,-1, GETDATE()) AND UpdatedDate <= DATEADD(month, -1, GETDATE())""" ,"","""ACCOUNTYPE
